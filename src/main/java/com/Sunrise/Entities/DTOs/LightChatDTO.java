...
public class LightChatDTO {
    ...
    public static LightChatDTO createPrivate(long id, long createdBy, long opponentId){
        return new LightChatDTO(id, null, false, opponentId, 0, 0, 0, 0, LocalDateTime.now(), createdBy, null, false);
    }
    public static LightChatDTO createGroup(long id, String name, long createdBy){
        return new LightChatDTO(id, name, true, null, 0, 0, 0, 0, LocalDateTime.now(), createdBy, null, false);
    }
}
